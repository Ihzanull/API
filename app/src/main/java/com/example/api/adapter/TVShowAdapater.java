...
import com.example.api.modelTVShow.ResultTVShow;
...
public class TVShowAdapater extends RecyclerView.Adapter<TVShowAdapater.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        viewHolder.rl_card.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String[] imports = { list.get(viewHolder.getAdapterPosition()).getOriginalName(),
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        Glide.with(context).load("https://image.tmdb.org/t/p/w185" + list.get(position).getPosterPath())
